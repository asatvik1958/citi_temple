(function () {
  ...
  async function loadComponents() {
    try {
      ...
      // Fallback: initialize anyway if components are already in HTML
      initializeApp();
    }
  }
  ...
  function initTranslations() {
    ...
    let translations = {
      en: {
        ...
        "nav.services.seva": "Sevas",
        "nav.services.donation": "Donation",
        "nav.contact": "Contact",
      ...
      te: {
        ...
        "nav.about": "గురించి",
        "nav.services": "సేవలు ▼",
        "nav.services.seva": "సేవలు",
        "nav.services.donation": "దానం",
    ...
    if (window.TRANSLATIONS && window.TRANSLATIONS.seva) {
      translations.en = Object.assign(translations.en, window.TRANSLATIONS.seva.en || {});
      translations.te = Object.assign(translations.te, window.TRANSLATIONS.seva.te || {});
    }
    if (window.TRANSLATIONS && window.TRANSLATIONS.contact) {
      translations.en = Object.assign(translations.en, window.TRANSLATIONS.contact.en || {});
      translations.te = Object.assign(translations.te, window.TRANSLATIONS.contact.te || {});
    }
    if (window.TRANSLATIONS && window.TRANSLATIONS.donations) {
      translations.en = Object.assign(translations.en, window.TRANSLATIONS.donations.en || {});
      translations.te = Object.assign(translations.te, window.TRANSLATIONS.donations.te || {});
    }
